        ...
        <div className="grid lg:grid-cols-[1fr_320px] gap-12 lg:gap-16">
          ...
          >
            <div>
              ...
              <a href="https://wa.me/5575981828601" target="_blank" rel="noopener noreferrer" className="text-sm text-dark-fg/80 link-underline inline-block w-fit">+55 (75) 9 8182-8601</a>
            </div>
            <div>
